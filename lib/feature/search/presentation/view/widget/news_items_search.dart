...
import 'package:newsify/feature/search/presentation/view/widget/news_details_search.dart';

class NewsItemsSearch extends StatelessWidget {
  const NewsItemsSearch({super.key, required this.newsItemModel});
